...
public class MyEntityChicken extends EntityAnimal
{
    /** AI task for player control. */
    private final EntityAIControlledByPlayer aiControlledByPlayer;

    public MyEntityChicken(World par1World)
    {
        super(par1World);
     ...
     */
    public MyEntityChicken spawnBabyAnimal(EntityAgeable par1EntityAgeable)
    {
        return new MyEntityChicken(this.worldObj);
    }
